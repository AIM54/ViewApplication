...
public class MyItemTouchListener extends RecyclerView.SimpleOnItemTouchListener {
    ...
    private class MyGestureListener extends GestureDetector.SimpleOnGestureListener {
        ...
        public boolean onScroll(MotionEvent e1, MotionEvent e2, float distanceX, float distanceY) {
            CommonLog.i(String.format("e1==null:%b||e2==null:%b",e1==null,e2==null));
            MotionEvent motionEvent=e1==null?e2:e1;
            if (mRecyclerView != null&&motionEvent!=null) {
                View view = mRecyclerView.findChildViewUnder(motionEvent.getX(mActivePointerId), motionEvent.getY(mActivePointerId));
                if (mRecyclerView.findContainingViewHolder(view) != null && mRecyclerView.findContainingViewHolder(view) instanceof BankAdapter.MyViewHolder) {
                    BankAdapter.MyViewHolder myViewHolder = (BankAdapter.MyViewHolder) mRecyclerView.findContainingViewHolder(view);
                    myViewHolder.onScroll(distanceX, distanceY);
                }
            }
            return true;
        }
        ...
        public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
            ...
            if (mRecyclerView != null&&motionEvent!=null) {
                ...
                if (mRecyclerView.findContainingViewHolder(view) != null && mRecyclerView.findContainingViewHolder(view) instanceof BankAdapter.MyViewHolder) {
                    BankAdapter.MyViewHolder myViewHolder = (BankAdapter.MyViewHolder) mRecyclerView.findContainingViewHolder(view);
                    myViewHolder.onFling(velocityX, velocityY);
                }
            }
            return true;
        }
