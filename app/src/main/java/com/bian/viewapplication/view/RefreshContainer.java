...
public class RefreshContainer extends ViewGroup implements NestedScrollingParent,
    ...
    private static final String LOG_TAG = RefreshContainer.class.getSimpleName();
    ...
    private int circleViewCenterX;
    private int circleViewCenterY;
     ...
     * @param attrs
     */
    public RefreshContainer(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    void startScaleDownAnimation(AnimationListener listener) {
        ...
        if (mTarget != null) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
                ...
                objectAnimator.addUpdateListener(animation -> animation.getAnimatedValue());
    ...
    /**
     * Set a callback to override {@link RefreshContainer#canChildScrollUp()} method. Non-null
    ...
    /**
     * Classes that wish to override {@link RefreshContainer#canChildScrollUp()} method
     * behavior should implement this interface.
     */
    public interface OnChildScrollUpCallback {
        /**
         * Callback that will be called when {@link RefreshContainer#canChildScrollUp()} method
         ...
         */
        boolean canChildScrollUp(@NonNull RefreshContainer parent, @Nullable View child);
    }
}
